import { LayoutDashboard, Calendar, Trophy, Clipboard, Award, Users, TrendingUp, ArrowLeftRight, UserCog, ListOrdered, Star, ShieldCheck, Sparkles, BookOpen } from 'lucide-react';
...
export const NAV_ITEMS = [
  ...
  { id: 'definitions', label: 'Definitions', icon: BookOpen,                group: 'reference' },
];
