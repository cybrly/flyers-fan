...
export const COACHES = [
  ...
  { abbr: 'PHI', team: 'Philadelphia Flyers',   name: 'Rick Tocchet',        hired: '2025', priorTeams: ['TBL (interim)', 'PHX/ARI', 'VAN'], highlight: 'Jack Adams 2024 · Cup 1992 (player)', biography: 'Two-time Flyer as a player; brought back to lead the rebuild after winning Jack Adams with Vancouver.' },
